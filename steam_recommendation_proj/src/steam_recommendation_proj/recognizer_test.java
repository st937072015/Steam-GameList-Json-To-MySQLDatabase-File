...
public class recognizer_test {
	...
	public static void main(String[] args) {
		...
		p.computeScoresOverCorpus(new File("C:\\Users\\John-Wall\\Desktop\\PersonalityRecognizer\\examples"), p.loadWekaModels(2, true, true), new File("C:\\Users\\John-Wall\\Desktop\\PersonalityRecognizer\\examples\\ex.arff"));
